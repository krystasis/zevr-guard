...
> **実装状況(2026-09-15 時点)**: A/B/C/D/E と R5/R6 はすべて実装済み。その後の再レビュー(A 優先 7 件 / B 5 件 / C)とリリース前レビュー(必須 2 件)も対応済み。単体 170 件、実機 121/121。残るは push・Worker デプロイ・フィード再配信・版上げ(§8)で、いずれも人の作業。
>
